...
const About = () => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.about-img',
        { opacity: 0, x: -60 },
        {
          ...
          scrollTrigger: { trigger: '.about-img', start: 'top 85%', toggleActions: 'play none none none' }
        }
      );
      ...
      gsap.fromTo('.about-pill',
        ...
        {
          opacity: 1, y: 0, scale: 1, duration: 0.5, stagger: 0.12, ease: 'back.out(1.7)',
          scrollTrigger: { trigger: '.about-pills', start: 'top 90%', toggleActions: 'play none none none' }
        }
      );
    }, sectionRef);
  ...
  return (
    <div ref={sectionRef} id="about" className='section bg-gradient-to-b from-gray-50 to-white py-20'>
      ...
      <section className="flex mt-16 flex-col md:flex-row items-center justify-center gap-12 lg:gap-20 max-w-6xl mx-auto px-6">
        {/* Image Container */}
        <div className="about-img md:w-1/2 relative group opacity-0">
        ...
        {/* Text Content */}
        <div className="about-text md:w-1/2 text-left opacity-0">
          ...
          <div className="about-pills flex flex-wrap gap-4 mt-6">
            {['Expert Stylists', 'Premium Products', 'Relaxing Ambiance'].map((feature, index) => (
              <div key={index} className="about-pill flex items-center gap-2 opacity-0">
