...
const Testimonial = () => {
  ...
  return (
    <div ref={sectionRef} id="testimonials" className='relative overflow-hidden py-20 bg-gradient-to-b from-gray-50 to-white'>
      {/* Decorative Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="testimonials-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
          {testimonials.map((testimonial, index) => (
            <div 
              key={testimonial.id} 
              className={`testimonial-card group relative bg-white rounded-2xl p-6 shadow-lg border border-gray-100
                hover:shadow-2xl hover:shadow-purple-500/10 hover:-translate-y-2 
                transition-all duration-500 opacity-0 ${index === 1 ? 'lg:scale-105 lg:z-10' : ''}`}
            >
